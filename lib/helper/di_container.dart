...
import 'package:motoboy/features/auth/domain/repositories/auth_repository.dart';
import 'package:motoboy/features/auth/domain/repositories/auth_repository_interface.dart';
import 'package:motoboy/features/auth/domain/services/auth_service.dart';
import 'package:motoboy/features/auth/domain/services/auth_service_interface.dart';
import 'package:motoboy/features/chat/controllers/chat_controller.dart';
import 'package:motoboy/features/chat/domain/repositories/chat_repository.dart';
import 'package:motoboy/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:motoboy/features/chat/domain/services/chat_service.dart';
import 'package:motoboy/features/chat/domain/services/chat_service_interface.dart';
import 'package:motoboy/features/dashboard/controllers/bottom_menu_controller.dart';
import 'package:motoboy/features/help_and_support/controllers/help_and_support_controller.dart';
import 'package:motoboy/features/help_and_support/domain/repositories/help_and_support_repository.dart';
import 'package:motoboy/features/help_and_support/domain/repositories/help_and_support_repository_interface.dart';
import 'package:motoboy/features/help_and_support/domain/services/help_and_support_service.dart';
import 'package:motoboy/features/help_and_support/domain/services/help_and_support_service_interface.dart';
import 'package:motoboy/features/leaderboard/controllers/leader_board_controller.dart';
import 'package:motoboy/features/leaderboard/domain/repositories/leader_board_repository.dart';
import 'package:motoboy/features/leaderboard/domain/repositories/leader_board_repository_interface.dart';
import 'package:motoboy/features/leaderboard/domain/services/leader_board_service.dart';
import 'package:motoboy/features/leaderboard/domain/services/leader_board_service_interface.dart';
import 'package:motoboy/features/location/controllers/location_controller.dart';
import 'package:motoboy/features/location/domain/repositories/location_repository.dart';
import 'package:motoboy/features/location/domain/repositories/location_repository_interface.dart';
import 'package:motoboy/features/location/domain/services/location_service.dart';
import 'package:motoboy/features/location/domain/services/location_service_interface.dart';
import 'package:motoboy/features/map/controllers/map_controller.dart';
import 'package:motoboy/features/map/controllers/otp_time_count_controller.dart';
import 'package:motoboy/features/notification/controllers/notification_controller.dart';
import 'package:motoboy/features/notification/domain/repositories/notification_repository.dart';
import 'package:motoboy/features/notification/domain/repositories/notification_repository_interface.dart';
import 'package:motoboy/features/notification/domain/services/notification_service.dart';
import 'package:motoboy/features/notification/domain/services/notification_service_interface.dart';
import 'package:motoboy/features/out_of_zone/controllers/out_of_zone_controller.dart';
import 'package:motoboy/features/out_of_zone/domain/repositories/out_of_zone_repository.dart';
import 'package:motoboy/features/out_of_zone/domain/repositories/out_of_zone_repository_interface.dart';
import 'package:motoboy/features/out_of_zone/domain/service/out_of_zone_service.dart';
import 'package:motoboy/features/out_of_zone/domain/service/out_of_zone_service_interface.dart';
import 'package:motoboy/features/profile/controllers/profile_controller.dart';
import 'package:motoboy/features/profile/domain/repositories/profile_repository.dart';
import 'package:motoboy/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:motoboy/features/profile/domain/services/profile_service.dart';
import 'package:motoboy/features/profile/domain/services/profile_service_interface.dart';
import 'package:motoboy/features/refer_and_earn/controllers/refer_and_earn_controller.dart';
import 'package:motoboy/features/refer_and_earn/domain/repositories/refer_earn_repository.dart';
import 'package:motoboy/features/refer_and_earn/domain/repositories/refer_earn_repository_intertface.dart';
import 'package:motoboy/features/refer_and_earn/domain/services/refer_earn_service.dart';
import 'package:motoboy/features/refer_and_earn/domain/services/refer_earn_service_interface.dart';
import 'package:motoboy/features/review/controllers/review_controller.dart';
import 'package:motoboy/features/review/domain/repositories/review_repository.dart';
import 'package:motoboy/features/review/domain/repositories/review_repository_interface.dart';
import 'package:motoboy/features/review/domain/services/review_service.dart';
import 'package:motoboy/features/review/domain/services/review_service_interface.dart';
import 'package:motoboy/features/ride/controllers/ride_controller.dart';
import 'package:motoboy/features/ride/domain/repositories/ride_repository.dart';
import 'package:motoboy/features/ride/domain/repositories/ride_repository_interface.dart';
import 'package:motoboy/features/ride/domain/services/ride_service.dart';
import 'package:motoboy/features/ride/domain/services/ride_service_interface.dart';
import 'package:motoboy/features/safety_setup/controllers/safety_alert_controller.dart';
import 'package:motoboy/features/safety_setup/domain/repositories/safety_alert_repository.dart';
import 'package:motoboy/features/safety_setup/domain/repositories/safety_alert_repository_interface.dart';
import 'package:motoboy/features/safety_setup/domain/services/safety_alert_service.dart';
import 'package:motoboy/features/safety_setup/domain/services/safety_alert_service_interface.dart';
...
import 'package:motoboy/features/splash/domain/repositories/splash_repository.dart';
import 'package:motoboy/data/api_client.dart';
import 'package:motoboy/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:motoboy/features/splash/domain/services/splash_service.dart';
import 'package:motoboy/features/splash/domain/services/splash_service_interface.dart';
import 'package:motoboy/features/trip/domain/repositories/trip_repository_interface.dart';
import 'package:motoboy/features/trip/domain/services/trip_service.dart';
import 'package:motoboy/features/trip/domain/services/trip_service_interface.dart';
import 'package:motoboy/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:motoboy/features/wallet/domain/services/wallet_service.dart';
import 'package:motoboy/features/wallet/domain/services/wallet_service_interface.dart';
...
import 'package:motoboy/features/trip/domain/repositories/trip_repository.dart';
import 'package:motoboy/features/wallet/controllers/wallet_controller.dart';
import 'package:motoboy/features/wallet/domain/repositories/wallet_repository.dart';
