...
class LoginHelper{
  ...
  void checkLoginRoutes(Map<String,dynamic>? notificationData, String? userName, {bool ignoreForceUpdate = false}){
    if(!ignoreForceUpdate && _isForceUpdate(Get.find<SplashController>().config)) {
      Get.offAll(()=> AppVersionWarningScreen(notificationData: notificationData, userName: userName));
