...
import 'package:motoboy/common_widgets/country_picker_widget.dart';
  ...
  Widget build(BuildContext context) {
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        SizedBox(width: widget.showCountryCode? Get.width * 0.27 : 80,
          child: Row(
            children: [
              ...
              Padding(
                ...
                child: Text(widget.countryDialCode ?? '+55', style: textRegular.copyWith(fontSize: Dimensions.fontSizeDefault),),
              ),
            ],
          ),
        ),
